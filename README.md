# VitalScan Supabase handoff bundle

This folder is a portable React + Vite application for moving VitalScan to another platform with Supabase as the database and authentication provider.
