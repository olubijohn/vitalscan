# PreCURE Supabase migration guide

This guide moves the PreCURE frontend away from the Replit API and its in-memory store. The companion `VitalScanSupabase.jsx` file is a portable React entry point that reads and writes Supabase directly through the Supabase JavaScript client.
